...
def download_mnist_data():
    ...
    request.urlretrieve(
        "{}/{}".format(parent, train_images_filename), train_images_filename)
    print("Downloading {}...".format(train_labels_filename))
    request.urlretrieve(
        "{}/{}".format(parent, train_labels_filename), train_labels_filename)
    print("Downloading {}...".format(test_images_filename))
    request.urlretrieve(
        "{}/{}".format(parent, test_images_filename), test_images_filename)
    print("Downloading {}...".format(test_labels_filename))
    request.urlretrieve(
        "{}/{}".format(parent, test_labels_filename), test_labels_filename)
    print("Done")
...
def extract_mnist_data():
    ...
    data_train, label_train = load_mnist(
        train_images_filename, train_labels_filename, n_train)
    print("Extracting test data...")
    data_test, label_test = load_mnist(
        test_images_filename, test_labels_filename, n_test)
    print("Done")

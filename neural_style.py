...
tf.app.flags.DEFINE_string("CONTENT_LAYERS", "relu3_3", "Which VGG layer to extract content loss from")
tf.app.flags.DEFINE_string("STYLE_LAYERS", "relu1_2,relu2_2,relu3_3,relu4_3", "Which layers to extract style from")
